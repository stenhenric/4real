...
const rawEnvSchema = z.object({
  ...
  MPESA_CODE_ALLOWED_YEARS: z.string().trim().default('R:2023,S:2024,T:2025,U:2026,V:2027'),
  MPESA_CODE_TIMEZONE: z.string().trim().default('Africa/Nairobi'),
  MPESA_CODE_ALLOW_INTERNAL_SPACES: booleanFromEnv.default(true),
  MPESA_CODE_PREVIOUS_DAY_GRACE_MINUTES: z.coerce.number().int().nonnegative().default(120),
  MPESA_CODE_MAX_FAILED_ATTEMPTS: z.coerce.number().int().positive().default(3),
  MPESA_CODE_ATTEMPT_LOCK_MS: z.coerce.number().int().positive().default(900_000),
  MPESA_CODE_DUPLICATE_POLICY: z.enum(['reject', 'allow']).default('reject'),
  ...
  AUTH_EMAIL_RECIPIENT_RATE_LIMIT_WINDOW_MS: z.coerce.number().int().positive().default(60 * 60 * 1000),
  AUTH_EMAIL_RECIPIENT_RATE_LIMIT_MAX: z.coerce.number().int().positive().default(5),
  DEPOSIT_OPERATION_RATE_LIMIT_WINDOW_MS: z.coerce.number().int().positive().default(60_000),
  DEPOSIT_OPERATION_RATE_LIMIT_MAX: z.coerce.number().int().positive().default(10),
  ORDER_CREATE_RATE_LIMIT_WINDOW_MS: z.coerce.number().int().positive().default(300_000),
  ORDER_CREATE_RATE_LIMIT_MAX: z.coerce.number().int().positive().default(5),
  MATCH_MUTATION_RATE_LIMIT_WINDOW_MS: z.coerce.number().int().positive().default(60_000),
  MATCH_MUTATION_RATE_LIMIT_MAX: z.coerce.number().int().positive().default(30),
  ADMIN_MUTATION_RATE_LIMIT_WINDOW_MS: z.coerce.number().int().positive().default(600_000),
  ADMIN_MUTATION_RATE_LIMIT_MAX: z.coerce.number().int().positive().default(10),
