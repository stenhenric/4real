...
const DashboardView: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
      {/* Left Column: Game Lobby */}
      <div className="lg:col-span-8 space-y-8">
        <div className="rough-border bg-white p-8 relative shadow-xl overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-8 relative z-10">
            ...
            <div className="flex flex-col items-end gap-2 text-right">
              ...
              <SketchyButton onClick={createGame} className="flex items-center gap-2 text-xl px-10">
        ...
        <div className="rough-border bg-white/50 p-8 shadow-inner relative">
      ...
      <div className="lg:col-span-4 space-y-8">
        <div className="sticky-note p-8 rough-border shadow-2xl relative">
        ...
        <div className="rough-border bg-white p-8 shadow-xl relative overflow-hidden">
