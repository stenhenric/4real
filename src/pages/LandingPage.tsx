...
export default function LandingPage() {
  ...
  const activeSection = location.hash || '#hero';

  return (
    <div className="space-y-8 pb-16">
      {(activeSection === '#hero' || activeSection === '') && (
        <div className="space-y-20 animate-in fade-in zoom-in-95 duration-300">
      ...
      {activeSection === '#how-it-works' && (
        <section className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300" id="how-it-works">
          <div className="max-w-3xl">
      ...
      {activeSection === '#security' && (
        <section className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300" id="security">
      ...
      {activeSection === '#features' && (
        <section className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300" id="features">
          <div className="max-w-3xl">
